  ...
  async function removeParticipant(activity, email) {
    try {
      ...
      if (response.ok) {
        ...
        // Refresh the activity list to reflect change
        fetchActivities();
      } else {
                   ...
                   .map(
                     (participant) =>
                       `<li>
                          ...
                          <button class="participant-remove" data-email="${participant}" aria-label="Remove participant">×</button>
                        </li>`
                   )
                   .join("")}
               </ul>
  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        messageDiv.className = "success";
        signupForm.reset();
        // Refresh the activity list to show the new participant
        fetchActivities();
      } else {
